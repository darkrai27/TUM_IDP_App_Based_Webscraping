...
def get_basic_info(url:str, dtsg: str = None, session_id: str = None):
  """
...
def download_media(postID:int,  path: str = None, dtsg: str = None, session_id: str = None):

  '''
  Downloads the media of a post
